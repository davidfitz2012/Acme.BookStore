...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p e37ce661-efc6-4900-bc73-9e4a68c2a838
```

> `e37ce661-efc6-4900-bc73-9e4a68c2a838` is the password of the certificate, you can change it to any password you want.
